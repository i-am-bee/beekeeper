...
const ENTRIES = [
  ...
  {
    toolName: "geo_area_lookup_api",
    description:
      "Returns the geographic bounding box (lat/lon) for a given place name or region identifier.",
    toolInput: '{"placeName":"<string>"}',
  },
  {
    toolName: "location_geocoder_api",
    description:
      "Returns latitude/longitude coordinates for a given location name.",
    toolInput: '{"locationName":"<string>"}',
  },
  {
    toolName: "relief_payload_estimator_api",
    description:
      "Estimates total payload weight based on population served and type/quantity of relief supplies.",
    toolInput: '{"population":<number>,"supplyCategories":["<string>"]}',
  },
  {
    toolName: "place_to_airstrip_matcher_api",
    description:
      "Returns nearby known airstrips for a named location or coordinate pair, to support routing or landing strip evaluation.",
    toolInput:
      '{"location":{"lat":<number>,"lon":<number>},"radiusKm":<number>}',
  },
  {
    toolName: "nearest_airbase_locator_api",
    description:
      "Returns the coordinates and ICAO code of the nearest operational airbase suitable for cargo flights, given a location or bounding box.",
    toolInput:
      '{"location":{"lat":<number>,"lon":<number>},"aircraftType":"<string>"}',
  },
  {
    toolName: "population_estimator_api",
    description:
      "Returns the estimated population for a specified region based on place name or geographic bounding box.",
    toolInput:
      '{"placeName":"<string>"} or {"areaBoundingBox":{"latMin":<number>,"latMax":<number>,"lonMin":<number>,"lonMax":<number>}}',
  },
