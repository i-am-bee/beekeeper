...
const ENTRIES = [
  {
    ...
    inputOutput: `input: location: "Sunnybrook Farm"; output: nectar suitability data`,
  ...
  },
  {
    ...
    inputOutput: `input: location: "Meadowland Reserve"; output: nectar suitability data`,
    resource: createResourceFixtures(
      {
        type: "tools",
        tools: [
  ...
  },
  {
    ...
    inputOutput: `input: location: "Sunnybrook Farm"; output: butterfly host compatibility data`,
    resource: createResourceFixtures(
      {
        type: "tools",
        tools: [
  ...
  },
  {
    ...
    resource: createResourceFixtures(
      ...
      { type: "task", task: tasksFixtures.get(`analyze_flora_for_butterfly_host_plants`) },
      {
        type: "task_run",
        taskRun: taskRunsFixtures.get("analyze_flora_for_butterfly_host_plants_2"),
      },
    ),
  },
  {
    ...
    resource: createResourceFixtures(
      ...
      { type: "agent", agent: agentsFixtures.get(`report_compiler_for_farming_suitability`) },
      { type: "task", task: tasksFixtures.get(`compile_farming_suitability_report`) },
      {
        type: "task_run",
