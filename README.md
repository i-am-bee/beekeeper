...
| **3** | Input the following prompt: <br> `I'm heading to Boston next week and need help planning a simple 3-day itinerary. I’ll be staying in Back Bay and want to see historical sites, catch a hockey or football game, and enjoy great food. Can you recommend one dinner spot each night - Italian, Chinese, and French?` | Observe the supervisor agent create tasks and generate specialized agents. |
